...
export const signup = async (req, res)=>{
    const {IdUser_PK, UserName, UserEmail, UserLastName,IdCompany_FK, avatar }=req.body;
...
export const setPermission = async (req, res)=>{ 
    ...
    try {
        ...
        const result = await pool.query("UPDATE users SET userPermission=? WHERE IdUser_PK = ?", [ cryptRol,IdUser_PK]);
        if(result.affectedRows)
